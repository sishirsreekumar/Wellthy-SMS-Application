...
app.post("/",(req,res)=>{
    ...
    if (call_status = "Ringing"){
        if (rnr = 1){
            ...
            var messsage = "Did you know cinnamon could help keep your blood sugar in control? Tap https://wellthy.page.link/XXEk to talk to your Health Coach for more tips!"
            var campaign = "RNR4"
        } else if (rnr=5) {
            var messsage = "Can't talk right now? Let's chat! Tap https://wellthy.page.link/XXEk to connect with your Health Coach on chat."
            var campaign = "RNR5"
        } else if (rnr=6) {
            var messsage = "Your health coach wants to talk to you about which exercises help improve blood sugar.Tap https://wellthy.page.link/XXEk to connect over chat."
            var campaign = "RNR6"
        } else if (rnr=7) {
            var messsage = "There's so much to know about managing your condition! Tap https://wellthy.page.link/XXEk to have a quick chat with your Health Coach. "
            var campaign = "RNR7"
        }
    }
