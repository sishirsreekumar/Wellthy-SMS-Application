...
app.post("/leads",(req,res)=>{
    ...
    if ( message_type == "Enrollment steps" ) {
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161200023033095",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161777499427991",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161777504946595",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161200055868473",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161200053289191",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161200063736519",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161200066791153",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161200073879101",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161777511563362",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161777517340137",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161777524194170",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161777528098138",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107161200029855309",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
        ...
        var options = {
            ...
            body: JSON.stringify({
                "sender": "MCHICL",
                "template_id": "1107164810375596399",
                "body": message,
                "type": "TXN",
                "to": (phone && String(phone).length <= 10 ? '+91' + phone: phone)
            }),
